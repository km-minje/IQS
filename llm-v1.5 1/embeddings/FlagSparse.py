...
class FlagSparse(BaseEmbedding):
    """
    ...
    def embed_documents(self, texts: List[str]) -> List[List[float]]:
        ...
        """
        return self.model.encode(texts, return_sparse=True)  # Flag 모델을 사용하여 문서 임베딩 후 리스트 반환
    ...
    def embed_query(self, text: str) -> List[float]:
        ...
        """
        return self.model.encode([text], return_sparse=True) # Flag 모델을 사용하여 쿼리 임베딩 후 리스트 반환
